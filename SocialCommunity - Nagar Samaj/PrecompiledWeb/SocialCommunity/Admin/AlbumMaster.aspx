<%@ page language="C#" masterpagefile="~/Admin/mstAdminPanel.master" autoeventwireup="true" inherits="Admin_AlbumMaster, App_Web_lloyrgkv" title="Nagar Bandhara Community | Album Master" %>
            ...
            <asp:Panel ID="pnlEntry" CssClass="ModalPopupDialog" runat="server">
                ...
                <table class="ContentMain">
                    <tr>
                        ...
                        <td class="TextArea">
                            <asp:TextBox CssClass="TextBox" ID="txtAlbumName" runat="server" Height="23px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                        ...
                        <asp:GridView ID="grdData" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-CssClass="ImageButton">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" ImageUrl="~/Images/Edit.png" CommandArgument='<%# Eval("AlbumCode") %>'
                                            runat="server" OnClick="imgbtnEdit_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-CssClass="ImageButton">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnDelete" ImageUrl="~/Images/Delete.png" CommandArgument='<%# Eval("AlbumCode") %>'
