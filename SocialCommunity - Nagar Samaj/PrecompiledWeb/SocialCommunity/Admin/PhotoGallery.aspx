<%@ page language="C#" masterpagefile="~/Admin/mstAdminPanel.master" autoeventwireup="true" inherits="Admin_PhotoGallery, App_Web_lloyrgkv" title="Nagar Bandhara Community | Photo Gallery" %>
            ...
            <asp:Panel ID="pnlEntry" CssClass="ModalPopupDialog" runat="server">
                ...
                <table class="ContentMain">
                    <tr>
                        ...
                        <td class="TextArea">
                            <asp:DropDownList ID="ddlAlbumName" CssClass="TextBox" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="TextArea">
                            <asp:TextBox CssClass="TextBox" ID="txtPhotoHead" runat="server">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <asp:GridView ID="grdData" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-CssClass="ImageButton">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnEdit" ImageUrl="~/Images/Edit.png" CommandArgument='<%# Eval("PhotoCode") %>'
                                            runat="server" OnClick="imgbtnEdit_Click" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-CssClass="ImageButton">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgbtnDelete" ImageUrl="~/Images/Delete.png" CommandArgument='<%# Eval("PhotoCode") %>'
                                ...
                                <asp:BoundField DataField="PhotoHead" HeaderStyle-HorizontalAlign="Left" HeaderText="Photo Name"
                                    SortExpression="PhotoHead" />
                                <asp:BoundField DataField="AlbumName" HeaderStyle-HorizontalAlign="Left" HeaderText="Album Name"
                                    SortExpression="AlbumName" />
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <img src='<%# ThumbImage(Eval("FileName")) %>' alt="NO IMAGE" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
