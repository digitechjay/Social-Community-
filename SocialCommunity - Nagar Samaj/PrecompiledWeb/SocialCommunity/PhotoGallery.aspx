<%@ page language="C#" masterpagefile="~/mstClientPage.master" autoeventwireup="true" inherits="PhotoGallery, App_Web_vr531huv" title="Photo Gallery | Nagar Bandhara Community" %>
                        ...
                        <div style="overflow: hidden; position: relative;" class="jcarousel-clip jcarousel-clip-horizontal">
                            <ul id="carousel_0">
                                <asp:Repeater ID="rptImageThumbnail" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <img onmouseover="ctl00_Contentplaceholder1_preview.src=img<%# Eval("PhotoCode") %>.src"
                                                id='img<%# Eval("PhotoCode") %>' src='PhotoGallery/<%# Eval("FileName") %>' alt="Image Not Loaded" />
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
