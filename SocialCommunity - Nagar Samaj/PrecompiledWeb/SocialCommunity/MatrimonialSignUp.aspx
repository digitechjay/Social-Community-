<%@ page language="C#" masterpagefile="~/mstClientPage.master" autoeventwireup="true" inherits="MatrimonialSignUp, App_Web_kfwzvjyo" title="Untitled Page" %>
    ...
    <div class="middle-cnt-full">
        <div class="abt_section-full">
            ...
            <div class="call-full">
                ...
                <p>
                    <asp:CheckBox ID="chkAgreement" runat="server" Text="" />I agree to the <a href="">
                    Privacy Policy</a> and <a href="">T&amp;C</a>.
                </p>
            ...
            <div class="call-full">
                ...
                <p>
                    ...
                    <br />
                    Password<br />
                    <asp:TextBox ID="txtLoginPassword" CssClass="TextBox" runat="server" 
                        TextMode="Password"></asp:TextBox>
                </p>
                <p>
