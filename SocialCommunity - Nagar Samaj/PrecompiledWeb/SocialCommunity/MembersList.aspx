<%@ page language="C#" masterpagefile="~/mstClientPage.master" autoeventwireup="true" inherits="MembersList, App_Web_vr531huv" title="Nagar Bandhara Community | Members List" %>
                                    ...
                                    <table width="100%" class="RadioBtnList">
                                        <asp:Repeater ID="rptData" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    <td rowspan="5">
                                                        <img class="thumbnails" src='<%# ThumbImage(Eval("PhotoPath")) %>' alt="NO IMAGE" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <strong>Address:</strong>
                                                        <%# DataBinder.Eval(Container.DataItem, "CurrentAddress")%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
